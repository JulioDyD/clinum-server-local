 ...
 * Touch_GT911.cpp
 *
 * Driver para el controlador de touch GT911 en ESP32-S3.
 * Permite inicializar, leer y procesar los datos del panel táctil capacitivo.
 *
...
// Estructura global para almacenar los datos de los puntos de contacto
struct GT911_Touch touch_data = {0};
// Lee datos de un registro del touch GT911 vía I2C
...
// Escribe datos en un registro del touch GT911 vía I2C
...
// Inicializa el touch GT911 y configura la interrupción
...
/* Reset controller */
// Realiza un reset físico al touch GT911
...
uint16_t X_MAX = 0;
uint16_t Y_MAX = 0;
// Lee la configuración y resolución máxima del touch GT911
...
// Lee los datos de los puntos de contacto y actualiza la estructura global
...
// Llama a la función de lectura de touch si hay una interrupción pendiente
...
// Obtiene las coordenadas y fuerza de los puntos tocados
...
// Ejemplo de función para leer y mostrar los datos del touch (debug)
...
// Manejador de interrupción: marca que hay un evento pendiente de touch
